...
<div class="p-4">
    <div class="flex items-center p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50" role="alert">
        ...
        <div>
            ...
            <p class="font-normal text-xs">Apakah Anda yakin ingin menghapus bidang keahlian ini?</p>
        </div>
    </div>
    ...
    <div class="mt-4">
        <form id="form"
            action="{{ route('admin.master.bidang-keahlian.destroy', $bidang_keahlian->bidang_keahlian_id) }}"
            method="POST">
            @csrf
            @method('DELETE')
