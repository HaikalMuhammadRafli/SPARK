...
<div class="p-4">
    <div class="flex items-center p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50" role="alert">
        ...
        <div>
            ...
            <p class="font-normal text-xs">Apakah Anda yakin ingin menghapus data dosen pembimbing ini?</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 rounded-lg">
        ...
        <div class="text-center border border-gray-200 py-2 rounded-tr-lg">
            <p class="text-sm text-gray-600">{{ $dosenPembimbing->nip }}</p>
        </div>
    </div>
    <div class="grid grid-cols-2 rounded-lg">
        <div class="text-center border border-gray-200 py-2 rounded-bl-lg">
            <h6 class="text-sm text-gray-600">Nama Dosen Pembimbing</h6>
        </div>
        <div class="text-center border border-gray-200 py-2 rounded-br-lg">
            <p class="text-sm text-gray-600">{{ $dosenPembimbing->nama }}</p>
        </div>
    </div>

    <div class="mt-4">
        <form id="form" data-nip="{{ $dosenPembimbing->nip }}">
